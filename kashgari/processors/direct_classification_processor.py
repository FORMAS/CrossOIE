...
class DirectClassificationProcessor(BaseProcessor):
    """
    Corpus Pre Processor class
    """

    def __init__(self, multi_label=False, **kwargs):
        super(DirectClassificationProcessor, self).__init__(**kwargs)
        self.multi_label = multi_label
        self.multi_label_binarizer: MultiLabelBinarizer = None

    def info(self):
        info = super(DirectClassificationProcessor, self).info()
    ...
    def process_x_dataset(self,
        ...
        return pad_sequences(target, max_len, dtype=float, padding='post', truncating='post')
...
if __name__ == "__main__":
    ...
    p = DirectClassificationProcessor()
