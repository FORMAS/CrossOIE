...
import kashgari
from kashgari.processors import ClassificationProcessor, LabelingProcessor, DirectProcessor
...
class Embedding(object):
    ...
    def info(self):
        return {
            ...
            'embed_model': json.loads(self.embed_model.to_json()) if isinstance(self.embed_model, keras.Model) else None,
        }
    ...
    def _load_saved_instance(cls,
        ...
        if 'Direct' not in processor_info['class_name']:
    ...
    def __init__(self,
        ...
        if processor is None:
            ...
            elif task == kashgari.RAW_LABELING:
